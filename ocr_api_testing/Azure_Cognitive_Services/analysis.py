...
def image_analysis_sample_analyze():
    ...
    service_options = visionsdk.VisionServiceOptions(endpoint="https://one800ocr.cognitiveservices.azure.com/", key="aed617482e9a40b08651ad8ed0c084c7")

    # Specify the image file on disk to analyze. sample1jpg is a good example to show most features
    vision_source = visionsdk.VisionSource(filename="image.png")
